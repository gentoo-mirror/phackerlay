...
EGO_SUM=(
	...
	"github.com/mdlayher/apcupsd v0.0.0-20220314153302-72ccd80310d1/go.mod"
...
SRC_URI="
	https://github.com/mdlayher/apcupsd_exporter/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	${EGO_SUM_SRC_URI}
"
